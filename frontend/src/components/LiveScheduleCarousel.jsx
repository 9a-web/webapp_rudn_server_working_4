...
export const LiveScheduleCarousel = ({ 
  ...
  return (
    <>
      ...
      <div className="flex gap-1 md:gap-4 mt-4 items-start pl-6 pr-15 md:px-0">
        ...
        <div className="flex flex-col items-center gap-3 md:hidden mt-8" style={{ marginLeft: '-30px' }}>
          {/* Кнопка вверх */}
          <motion.button
